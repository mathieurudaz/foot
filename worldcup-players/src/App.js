  ...
  render() {
    return (
      <div className={"app style-" + this.state.currentTemplate}>
        ...
        <div className="container-fluid container-zoom">
          <div className="row">
          ...
          <div className="row">
            <div className="col-md-6 col-md-offset-3">
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris vulputate, tellus et convallis ultrices, metus dolor accumsan magna, efficitur consectetur arcu justo eget orci. Vivamus ut ante auctor, sagittis leo ultrices, facilisis diam. Quisque dui nulla, mollis eu convallis ut, pretium nec leo. Phasellus pharetra elit a aliquam commodo. Duis arcu ipsum, tempus id purus elementum, pulvinar vestibulum justo. Vestibulum scelerisque egestas nunc in dictum. Mauris eu purus a lectus ornare gravida.</p>
        ...
        <div className="container-fluid container-swiss">
          <div className="row">
            <div className="col-md-6 col-md-offset-3">
          ...
          <div className="row">
            <div className="col-md-6 col-md-offset-3">
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean eget justo eget quam sodales suscipit. Sed quis pretium dolor. Maecenas malesuada, orci vitae dictum ullamcorper, tortor dolor elementum mauris, eu consectetur mauris lectus vel ligula. In porttitor lacus eget maximus luctus. Donec consectetur, tellus sed elementum bibendum, elit nisl pellentesque dui, sit amet dictum massa orci vel odio. Nulla volutpat lobortis lectus, at placerat dolor sagittis rutrum. Phasellus in libero sapien. Nunc varius massa in urna volutpat, vitae porta lacus semper.</p>
              ...
              <p>Sed sit amet lacinia neque. Ut eget urna id augue viverra maximus. Curabitur consequat massa elit, sit amet fermentum leo scelerisque ut. Quisque leo turpis, posuere vitae mauris at, hendrerit hendrerit diam. Donec at faucibus sem. Maecenas et rhoncus diam. Maecenas id nunc sed eros imperdiet feugiat. Mauris eu rutrum enim. Cras vel odio a leo venenatis facilisis vel quis lacus. Phasellus hendrerit condimentum malesuada. Fusce finibus non magna sit amet convallis. Fusce tempor nisl tortor, nec suscipit nunc laoreet at. Vestibulum lacus turpis, convallis nec pellentesque vitae, finibus quis est. Vivamus eu enim nec ex interdum pretium et non magna. Fusce consectetur, elit vel lacinia convallis, felis nulla fermentum arcu, finibus tristique ex purus vel lectus.</p>
